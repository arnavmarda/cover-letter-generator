...
def generate_cover_letter(name, job_title, company_name, job_description):
    ...
    (prompt, response) : tuple
        Tuple containing the prompt and response generated by the model where the response is the cover letter generated.
    """
    ...
    prompt_template = """Use the resume, example cover letter, name of applier, job title, job description, and company name below to write a 400 word cover letter.
    ...
    prompt = PROMPT.format(resume=extracted_docs, name=name, job_title=job_title, job_description=job_description, company_name=company_name)
